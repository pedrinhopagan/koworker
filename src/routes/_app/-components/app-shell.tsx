...
export function AppShell({ children }: AppShellProps) {
	...
	return (
		<div
			className="flex-1 flex bg-background text-foreground overflow-hidden"
			style={shellStyle}
		>
			<AccentStripe />
			...
			<div className="flex flex-col flex-1 min-h-0">
				...
				<main className="flex-1 flex flex-col overflow-hidden min-h-0 bg-background" style={mainStyle}>
					{children}
				</main>
			</div>
		</div>
